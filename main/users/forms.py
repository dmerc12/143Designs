...
class AdminChangePasswordForm(SetPasswordForm):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['new_password1'].widget.attrs['class'] = 'form-control'
		self.fields['new_password1'].label = ''
		self.fields['new_password1'].help_text = '<ul class="form-text text-muted small"><li>The password can\'t be too similar to other personal information.</li><li>The password must contain at least 8 characters.</li><li>The password can\'t be a commonly used password.</li><li>The password can\'t be entirely numeric.</li></ul>'
